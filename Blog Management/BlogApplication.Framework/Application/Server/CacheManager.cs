...
namespace BlogApplication.Framework.Application.Server
{
    public static class CacheManager
    {
        ...
        {
            get { return Convert.ToInt32(ConfigurationParameter.GetParameter("CacheDuration", "1440")); }
        }

        public static long CacheCount
        {
            get { return _MemoryCacheContext.GetCount(); }
        }
